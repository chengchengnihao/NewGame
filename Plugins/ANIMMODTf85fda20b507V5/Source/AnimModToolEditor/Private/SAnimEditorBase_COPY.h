...
class SAnimEditorBase_COPY : public SCompoundWidget, public FGCObject
{
public:
	SLATE_BEGIN_ARGS(SAnimEditorBase_COPY)
	...
	SLATE_ARGUMENT( TSharedPtr<FAnimModel_COPY>, AnimModel )
	...
	{
		return TEXT("SAnimEditorBase_COPY");
	}
...
protected:
	...
	TSharedPtr<class SAnimationScrubPanel_COPY> AnimScrubPanel;
	...
	/** The timeline widget */
	TSharedPtr<SAnimTimeline_COPY> TimelineWidget;
