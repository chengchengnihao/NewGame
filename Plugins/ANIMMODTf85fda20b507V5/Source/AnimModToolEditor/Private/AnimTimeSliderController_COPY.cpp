...
struct FAnimTimeSliderController_COPY::FScrubRangeToScreen
{
	double ViewStart;
...
FAnimTimeSliderController_COPY::FAnimTimeSliderController_COPY( const FTimeSliderArgs& InArgs, TWeakPtr<FAnimModel_COPY> InWeakModel, TWeakPtr<SAnimTimeline_COPY> InWeakTimeline, TSharedPtr<INumericTypeInterface<double>> InSecondaryNumericTypeInterface )
...
FFrameTime FAnimTimeSliderController_COPY::ComputeFrameTimeFromMouse(const FGeometry& Geometry, FVector2D ScreenSpacePosition, FScrubRangeToScreen RangeToScreen, bool CheckSnapping) const
{
...
FAnimTimeSliderController_COPY::FScrubPixelRange FAnimTimeSliderController_COPY::GetHitTestScrubberPixelRange(FFrameTime ScrubTime, const FScrubRangeToScreen& RangeToScreen) const
{
...
FAnimTimeSliderController_COPY::FScrubPixelRange FAnimTimeSliderController_COPY::GetScrubberPixelRange(FFrameTime ScrubTime, const FScrubRangeToScreen& RangeToScreen) const
{
	return GetScrubberPixelRange(ScrubTime, GetTickResolution(), GetDisplayRate(), RangeToScreen);
}

FAnimTimeSliderController_COPY::FScrubPixelRange FAnimTimeSliderController_COPY::GetScrubberPixelRange(FFrameTime ScrubTime, FFrameRate Resolution, FFrameRate PlayRate, const FScrubRangeToScreen& RangeToScreen, float DilationPixels) const
{
...
struct FAnimTimeSliderController_COPY::FDrawTickArgs
{
...
void FAnimTimeSliderController_COPY::DrawTicks( FSlateWindowElementList& OutDrawElements, const TRange<double>& ViewRange, const FScrubRangeToScreen& RangeToScreen, FDrawTickArgs& InArgs ) const
{
	TSharedPtr<SAnimTimeline_COPY> Timeline = WeakTimeline.Pin();
	if(!Timeline.IsValid())
	{
		return;
	}
...
int32 FAnimTimeSliderController_COPY::OnPaintTimeSlider( bool bMirrorLabels, const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FWidgetStyle& InWidgetStyle, bool bParentEnabled ) const
{
...
int32 FAnimTimeSliderController_COPY::DrawSelectionRange(const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FScrubRangeToScreen& RangeToScreen, const FPaintPlaybackRangeArgs& Args) const
{
...
int32 FAnimTimeSliderController_COPY::DrawPlaybackRange(const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FScrubRangeToScreen& RangeToScreen, const FPaintPlaybackRangeArgs& Args) const
{
...
int32 FAnimTimeSliderController_COPY::DrawEditableTimes(const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, const FScrubRangeToScreen& RangeToScreen) const
{
...
FReply FAnimTimeSliderController_COPY::OnMouseButtonDown( SWidget& WidgetOwner, const FGeometry& MyGeometry, const FPointerEvent& MouseEvent )
{
	DistanceDragged = 0;
...
FReply FAnimTimeSliderController_COPY::OnMouseButtonUp( SWidget& WidgetOwner, const FGeometry& MyGeometry, const FPointerEvent& MouseEvent )
{
...
FReply FAnimTimeSliderController_COPY::OnMouseMove( SWidget& WidgetOwner, const FGeometry& MyGeometry, const FPointerEvent& MouseEvent )
{
...
void FAnimTimeSliderController_COPY::CommitScrubPosition( FFrameTime NewValue, bool bIsScrubbing )
{
...
FReply FAnimTimeSliderController_COPY::OnMouseWheel( SWidget& WidgetOwner, const FGeometry& MyGeometry, const FPointerEvent& MouseEvent )
{
...
FCursorReply FAnimTimeSliderController_COPY::OnCursorQuery( TSharedRef<const SWidget> WidgetOwner, const FGeometry& MyGeometry, const FPointerEvent& CursorEvent ) const
{
...
int32 FAnimTimeSliderController_COPY::OnPaintViewArea( const FGeometry& AllottedGeometry, const FSlateRect& MyCullingRect, FSlateWindowElementList& OutDrawElements, int32 LayerId, bool bEnabled, const FPaintViewAreaArgs& Args ) const
{
	const ESlateDrawEffect DrawEffects = bEnabled ? ESlateDrawEffect::None : ESlateDrawEffect::DisabledEffect;
	...
	TSharedPtr<FAnimModel_COPY> AnimModel = WeakModel.Pin();
...
FFrameTime FAnimTimeSliderController_COPY::GetFrameTimeFromMouse(const FGeometry& Geometry, FVector2D ScreenSpacePosition) const
{
...
TSharedRef<SWidget> FAnimTimeSliderController_COPY::OpenSetPlaybackRangeMenu(FFrameNumber FrameNumber)
{
	...
	MenuBuilder.BeginSection("AnimSelectionRangeMenu", FText::Format(LOCTEXT("SelectionRangeTextFormat", "Selection Range ({0}):"), CurrentTimeText));
	{
		MenuBuilder.AddMenuEntry(
			...
			FUIAction(
				...
				FCanExecuteAction::CreateLambda([SelectionRange, FrameNumber]{ return SelectionRange.IsEmpty() || FrameNumber < UE::MovieScene::DiscreteExclusiveUpper(SelectionRange); })
			)
		);
		...
		MenuBuilder.AddMenuEntry(
			...
			FUIAction(
				...
				FCanExecuteAction::CreateLambda([SelectionRange, FrameNumber]{ return SelectionRange.IsEmpty() || FrameNumber >= UE::MovieScene::DiscreteInclusiveLower(SelectionRange); })
			)
		);
		...
		MenuBuilder.AddMenuEntry(
			...
			FUIAction(
				...
				FCanExecuteAction::CreateLambda([SelectionRange]{ return !SelectionRange.IsEmpty(); })
			)
		);
	}
...
void FAnimTimeSliderController_COPY::ClampViewRange(double& NewRangeMin, double& NewRangeMax)
{
...
void FAnimTimeSliderController_COPY::SetViewRange( double NewRangeMin, double NewRangeMax, EViewRangeInterpolation Interpolation )
{
...
void FAnimTimeSliderController_COPY::SetClampRange( double NewRangeMin, double NewRangeMax )
{
...
void FAnimTimeSliderController_COPY::SetPlayRange( FFrameNumber RangeStart, int32 RangeDuration )
{
...
bool FAnimTimeSliderController_COPY::ZoomByDelta( float InDelta, float MousePositionFraction )
{
...
void FAnimTimeSliderController_COPY::PanByDelta( float InDelta )
{
...
bool FAnimTimeSliderController_COPY::HitTestRangeStart(const FScrubRangeToScreen& RangeToScreen, const TRange<double>& Range, float HitPixel) const
{
...
bool FAnimTimeSliderController_COPY::HitTestRangeEnd(const FScrubRangeToScreen& RangeToScreen, const TRange<double>& Range, float HitPixel) const
{
...
bool FAnimTimeSliderController_COPY::HitTestTime(const FScrubRangeToScreen& RangeToScreen, double Time, float HitPixel) const
{
...
void FAnimTimeSliderController_COPY::SetPlaybackRangeStart(FFrameNumber NewStart)
{
	TRange<FFrameNumber> PlaybackRange = TimeSliderArgs.PlaybackRange.Get();
...
void FAnimTimeSliderController_COPY::SetPlaybackRangeEnd(FFrameNumber NewEnd)
{
	TRange<FFrameNumber> PlaybackRange = TimeSliderArgs.PlaybackRange.Get();
...
void FAnimTimeSliderController_COPY::SetSelectionRangeStart(FFrameNumber NewStart)
{
	TRange<FFrameNumber> SelectionRange = TimeSliderArgs.SelectionRange.Get();
...
void FAnimTimeSliderController_COPY::SetSelectionRangeEnd(FFrameNumber NewEnd)
{
	TRange<FFrameNumber> SelectionRange = TimeSliderArgs.SelectionRange.Get();
...
int32 FAnimTimeSliderController_COPY::HitTestTimes(const FScrubRangeToScreen& RangeToScreen, float HitPixel) const
{
...
void FAnimTimeSliderController_COPY::SetEditableTime(int32 TimeIndex, float Time, bool bIsDragging)
{
	TSharedPtr<FAnimModel_COPY> Model = WeakModel.Pin();
