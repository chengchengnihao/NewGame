...
struct FPaintSectionAreaViewArgs_COPY
{
	FPaintSectionAreaViewArgs_COPY()
 ...
 */
class FAnimTimeSliderController_COPY : public ITimeSliderController
{
public:
	FAnimTimeSliderController_COPY( const FTimeSliderArgs& InArgs, TWeakPtr<FAnimModel_COPY> InWeakModel, TWeakPtr<SAnimTimeline_COPY> InWeakTimeline, TSharedPtr<INumericTypeInterface<double>> InSecondaryNumericTypeInterface );
...
private:
	...
	TWeakPtr<SAnimTimeline_COPY> WeakTimeline;
