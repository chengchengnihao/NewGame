...
void STimingTrack_COPY::Construct(const FArguments& Args)
{
...
void STimingTrack_COPY::OnArrangeChildren(const FGeometry& AllottedGeometry, FArrangedChildren& ArrangedChildren) const
{
