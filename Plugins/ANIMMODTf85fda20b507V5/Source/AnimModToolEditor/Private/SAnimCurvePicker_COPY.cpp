...
#define LOCTEXT_NAMESPACE "SAnimCurvePicker_COPY"

SAnimCurvePicker_COPY::~SAnimCurvePicker_COPY()
{}

void SAnimCurvePicker_COPY::Construct(const FArguments& InArgs, const TSharedRef<IEditableSkeleton>& InEditableSkeleton)
{
	...
	SAssignNew(SearchBox, SSearchBox)
		...
		.OnTextChanged(this, &SAnimCurvePicker_COPY::HandleFilterTextChanged);

	SAssignNew(NameListView, SListView<TSharedPtr<FSmartName>>)
		.SelectionMode(ESelectionMode::Single)
		.ListItemsSource(&CurveNames)
		.OnSelectionChanged(this, &SAnimCurvePicker_COPY::HandleSelectionChanged)
		.OnGenerateRow(this, &SAnimCurvePicker_COPY::HandleGenerateRow);
...
void SAnimCurvePicker_COPY::HandleSelectionChanged(TSharedPtr<FSmartName> InItem, ESelectInfo::Type InSelectionType)
{
...
TSharedRef<ITableRow> SAnimCurvePicker_COPY::HandleGenerateRow(TSharedPtr<FSmartName> InItem, const TSharedRef<STableViewBase>& InOwnerTable)
{
	return
...
void SAnimCurvePicker_COPY::RefreshListItems()
{
...
void SAnimCurvePicker_COPY::FilterAvailableCurves()
{
	CurveNames.Reset();
...
void SAnimCurvePicker_COPY::HandleFilterTextChanged(const FText& InFilterText)
{
