 ...
 */
class SAnimTimelineOverlay_COPY : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS( SAnimTimelineOverlay_COPY )
	...
	void Construct( const FArguments& InArgs, TSharedRef<FAnimTimeSliderController_COPY> InTimeSliderController )
	{
...
private:
	...
	TSharedPtr<FAnimTimeSliderController_COPY> TimeSliderController;
